...
argument-hint: "[PR-URL | TRACING-XXXX]"
---
...
/make-jira-from-spec TRACING-1234
```
...
```bash
acli jira workitem search --jql 'parent = TRACING-XXXX AND issuetype = Epic AND resolution = Unresolved' --json
```
...
> Provide a Jira key (e.g. TRACING-1234).
...
```bash
acli jira workitem search --jql 'parent = TRACING-XXXX OR "Epic Link" = TRACING-XXXX' --json
```
...
| Key          | Change                              |
|--------------|-------------------------------------|
| TRACING-1234 | Update AC to reflect new constraint |
| TRACING-1235 | Add scope from new spec section     |
...
```bash
acli jira workitem edit --key "TRACING-XXXX" --description "{updated description}"
```
...
```
/estimate-story TRACING-1001 TRACING-1002 TRACING-1003
```

Invoke `/estimate-risk` with all story keys:
```
/estimate-risk TRACING-1001 TRACING-1002 TRACING-1003
```
...
```
Story TRACING-1002 estimated at 8 SP — splitting:

| # | Summary                    | Parent       |
|---|----------------------------|--------------|
| 1 | {sub-story 1}              | TRACING-2001 |
| 2 | {sub-story 2}              | TRACING-2001 |
| 3 | {sub-story 3}              | TRACING-2002 (new Epic) |
...
|--------------|-------|----------------------|----|------|---------|
| TRACING-2001 | Epic  | {summary}            | —  | —    | Created |
| TRACING-1001 | Story | {summary}            | 3  | 2    | Created |
| TRACING-1002 | Story | {summary}            | 2  | 1    | Created |
| TRACING-1234 | Story | {summary}            | 3  | 2    | Updated |

Epics sized: TRACING-2001 → 2 sprints (30 SP)
